            ...
            <header className="fixed top-0 left-0 right-0 z-10 shadow-md p-4 flex justify-between items-center bg-white" style={{ borderBottom: `2px solid ${primaryColor}` }}>
                ...
                <div className="flex items-center gap-3">
                    ...
                    >
                        ...
                        {notifications.length > 0 && (
                            <span className="absolute top-1 right-1 text-xs w-6 h-6 flex items-center justify-center text-xs font-bold text-white rounded-full" style={{ backgroundColor: primaryColor }}>
                                {notifications.length}
                            </span>
                        )}
                    </button>
                    ...
                    >
                        ...
                        <div className="space-y-3 text-gray-700">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <span className="font-semibold">{t.branchPhone}:</span>
